            ...
            this.OverlappingMarkerSpiderfier = function() {
                ...
                c.F = function(b, d) {
                    ...
                    for (x = n.length; l < x; l++)
                        a = n[l],
                        a.map != u && a.getVisible() && (g = this.c(a.position),
                        this.f(g, f) < m ? e.push({
                            A: a,
                            p: g
                        }) : c.push(a));
                    if(1 == e.length) this.fireMarkerRealClickEvent();
                    return 1 === e.length ? this.trigger("click", b, d) : this.G(e, c)
                }
                ;
                c.fireMarkerRealClickEvent = function(){
                	var event = new CustomEvent("markerRealClickEvent", {});
                ...
                c.markersNearMarker = function(b, d) {
                    ...
                    for (l = x.length; m < l; m++)
                        if (a = x[m],
                        !(a === b || a.map == u || !a.getVisible()))
                            if (g = this.c((n = (p = a._omsData) != u ? p.l : void 0) != u ? n : a.position),
                            this.f(g, f) < c && (e.push(a),
                            d))
                                break;
                    return e
                }
                ...
                c.markersNearAnyOtherMarker = function() {
                    ...
                    for (l = n.length; r < l; d = ++r)
                        if (a = n[d],
                        a.map != u && a.getVisible() && (g = e[d],
                        !g.d)) {
                            k = this.a;
                            a = m = 0;
                            for (p = k.length; m < p; a = ++m)
                                if (c = k[a],
                                a !== d && (c.map != u && c.getVisible()) && (c = e[a],
                                (!(a < d) || c.d) && this.f(g.q, c.q) < b)) {
                                    g.d = c.d = h;
                                    break
                                }
                        }
                ...
                c.G = function(b, d) {
                    ...
                    a = function() {
                        ...
                        for (d = e.length; a < d; a++)
                            ...
                            this.legColors.highlighted[this.map.mapTypeId] !== this.legColors.usual[this.map.mapTypeId] && (r = this.z(l),
                            l._omsData.w = {
                ...
                c.unspiderfy = function(b) {
                    ...
                    for (k = m.length; e < k; e++)
                        a = m[e],
                        a._omsData != u ? (a._omsData.i.setMap(u),
                        a !== b && a.setPosition(a._omsData.l),
                        a.setZIndex(u),
                        d = a._omsData.w,
                        d != u && (p.removeListener(d.h),
                        p.removeListener(d.k)),
                        delete a._omsData,
                        f.push(a)) : c.push(a);
                    delete this.t;
                    delete this.r;
